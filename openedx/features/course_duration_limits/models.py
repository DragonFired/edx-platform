...
from openedx.features.content_type_gating.helpers import CONTENT_GATING_PARTITION_ID, CONTENT_TYPE_GATE_GROUP_IDS, not_correct_modes_for_fbe
...
class CourseDurationLimitConfig(StackedConfigurationModel):
    ...
    def enabled_for_enrollment(cls, enrollment=None, user=None, course_key=None):
        ...
        if enrollment is None or not_student_masquerade:
            ...
            if not_correct_modes_for_fbe(course_key, enrollment, user):
                return False
    ...
    def enabled_for_course(cls, course_key, target_datetime=None):
        ...
        """
        if not_correct_modes_for_fbe(course_key):
            return False
